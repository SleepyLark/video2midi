...
to deselect the key press ctrl + left mouse button on empty space.""" )
    ...
    def addButtons(self): 
        ...
        self.root.appendChild( GLButton(265,45 ,155,22,1, [96 ,96 ,128], "snap notes to grid" ,self.app.snap_notes_to_the_grid,switch=1, switch_status=use_snap_notes_to_grid) )
